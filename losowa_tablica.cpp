...
\t0 - wyjscie z programu\n";
  ...
  while (wybor != 0) {
    ...
    cout << endl << "Wybor (4 - wyswietl menu): ";
    ...
    case 1:
      cout << "Podaj gorna granice zakresu wartosci liczb losowych: ";
      cin >> x;
    ...
    case 3:
      cout << "Najwieksza liczba w tablicy: "
	   << znajdzMaks(tab, nWierszy, mKolumn)
	   << endl;
      break;
